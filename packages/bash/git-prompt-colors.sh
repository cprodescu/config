...
local PathShort="\w"
local MyRed="\[\033[1;31m\]"
local MyYellow="\[\033[1;33m\]"
...
GIT_PROMPT_REMOTE=" ${Yellow}"        # the remote branch name (if any) and the symbols for ahead and behind
...
GIT_PROMPT_START_USER="${MyYellow}\u@\h:${MyRed}${PathShort}${ResetColor}"
GIT_PROMPT_START_ROOT="${White}${Time12a} ${MyRed}${PathShort}${ResetColor}"
GIT_PROMPT_END_USER=" "
GIT_PROMPT_END_ROOT="# "
